		...
		<div class="div">
			...
			<form action="registrar_profesional.php" method="post" accept-charset="utf-8" name="formulario" class="form-group">
				<div class="form-group">
					...
					<p>1. ¿Ha cursado otros estudios de Post Grado despues de su egreso de la carrera de Enfermería?</p>
				...
				<div class="form-group">
					<p>2. Marque las necesidades de educacion continua que Ud. requiere y el grado academico que le gustaria lograr.</p>
